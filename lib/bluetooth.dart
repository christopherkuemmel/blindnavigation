...
class _BluetoothAppState extends State<BluetoothApp> {
  ...
  void sendCommand() {
    bluetooth.write("2b2769292a17c3282d17c3284c2b");
  }
  ...
  void _sendOnMessageToBluetooth() {
    bluetooth.isConnected.then((isConnected) {
      if (isConnected) {
        // bluetooth.write("1");
        // bluetooth.write("+'i)*\x17\xc3(-\x17\xc3(L+");
        // TODO: send dynamic messages:
        //       implement lrc
        //       implement cobs encoding
        List<int> list = "+'i)*\x17\xc3(-\x17\xc3(L+".codeUnits;
        Uint8List bytes = Uint8List.fromList(list);
        bluetooth.writeBytes(bytes);

        show('Device Turned On');
        // show("+'i)*\x17\xc3(-\x17\xc3(L+");
      }
    });
  }
